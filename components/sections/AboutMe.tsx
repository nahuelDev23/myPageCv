      ...
      >
        <Stack>
          <Stack>
            ...
            <Text>
              En 2011 empezó a desarrollar como pasa tiempo, creando webs para
              sus amigos y en 2020 comenzó a considerar trabajar de lo que ama.
            </Text>

            <Text>
              <Highlighter text="Con perfil más orientado al fullstack" />, dio
              sus primeros pasos hacia el backend de la mano de PHP, luego
              conoció el mundo de los frameworks, siendo Laravel el primero en
              ser aprendido.
            </Text>
            ...
            <Text>
              Una vez se sintió comodo con los tres poderes básicos quedaba dar
              el paso hacia los frameworks que le ofrecía Javascript,pero eran
              MILES!.
            </Text>

            <Text>
              <Highlighter text="Vue.js " />
              fue el elegido en esta nueva aventura, ya que Laravel le ofrecía
              una integración sencilla por lo que no tenia que preocuparse por
              mas nada que en comenzar a aprender.
            </Text>
